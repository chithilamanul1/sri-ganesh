...
export function SiteHeader({ overlay = false }: SiteHeaderProps) {
  ...
  return (
    ...
    >
      ...
      <div 
        className={`fixed inset-0 z-[10000] lg:hidden transition-all duration-500 ease-in-out ${menuOpen ? 'visible opacity-100' : 'invisible opacity-0 pointer-events-none'}`}
      >
        {/* Solid background */}
