    ...
    <div className="min-h-screen bg-peach text-brown">
      ...
      <main>
        <section className="relative flex min-h-[680px] items-end overflow-hidden bg-brown pb-14 pt-28 sm:min-h-[720px] sm:pb-20">
          <video autoPlay loop muted playsInline src="/IMG_2292.MOV" className="absolute inset-0 h-full w-full object-cover opacity-45" />
          ...
          <div className="relative mx-auto w-full max-w-7xl px-5 sm:px-8 lg:px-10">
            <motion.div initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.65 }} className="max-w-3xl">
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                <Link href="/products" className="inline-flex items-center gap-2 bg-green px-6 py-4 text-xs font-extrabold uppercase tracking-[0.13em] text-white transition hover:bg-green-dark">
                  Explore our products <ArrowRightIcon size={16} />
                </Link>
                <Link href="/about" className="inline-flex items-center gap-2 border border-white/40 px-6 py-4 text-xs font-extrabold uppercase tracking-[0.13em] text-white transition hover:border-green-light hover:text-green-light">
                  Our export promise
                </Link>
              </div>
            </motion.div>
        ...
        <section className="py-16 sm:py-20 lg:py-24">
          <div className="mx-auto grid max-w-7xl items-center gap-10 px-5 sm:px-8 lg:grid-cols-2 lg:gap-16 lg:px-10">
            <img src="/image3.JPG" alt="Boat travelling across Sri Lankan ocean waters" className="h-[430px] w-full object-cover sm:h-[520px] rounded-lg shadow-xl" />
            <div className="max-w-xl">
              ...
              <Link href="/about" className="mt-9 inline-flex items-center gap-2 border-b-2 border-green pb-2 text-xs font-extrabold uppercase tracking-[0.12em] text-brown">
        ...
        <section className="bg-peach-dark py-16 sm:py-20 lg:py-24">
          <div className="mx-auto max-w-7xl px-5 sm:px-8 lg:px-10">
            <div className="flex flex-col justify-between gap-5 border-b border-brown/20 pb-8 md:flex-row md:items-end">
              ...
              <Link href="/products" className="inline-flex items-center gap-2 text-xs font-extrabold uppercase tracking-[0.12em] text-brown">
