    ...
    <div className="min-h-screen bg-ocean text-slate-200">
      ...
      <main>
        <PageHero
          ...
          image="/IMG_1025.JPG"
        />
        <section className="bg-ocean relative overflow-hidden py-20 sm:py-32">
          ...
          <div className="mx-auto grid max-w-7xl gap-16 px-5 sm:px-8 lg:grid-cols-[0.8fr_1.2fr] lg:gap-20 lg:px-10 relative z-10">
            <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }}>
              <p className="text-[10px] font-extrabold uppercase tracking-[0.22em] text-teal">Built for confident trade</p>
              ...
              <div className="mt-10 flex gap-5 rounded-2xl border border-glass-border bg-glass p-6 backdrop-blur-md hover:bg-white/5 transition-colors">
                <ShieldCheckIcon className="shrink-0 text-teal w-8 h-8" />
            ...
            <ol className="border-t border-glass-border">
              {stages.map(([number, title, text], i) => (
                ...
                >
                  <span className="font-serif text-4xl text-teal/40 transition-colors group-hover:text-teal pt-1">{number}</span>
                  <div>
          ...
          <div className="mx-auto max-w-7xl px-5 sm:px-8 lg:px-10">
            <div className="grid gap-12 lg:gap-8 md:grid-cols-3">
              {[
                ...
                >
                  <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-teal/10 via-teal to-teal/10 transform -translate-x-full group-hover:translate-x-0 transition-transform duration-700" />
