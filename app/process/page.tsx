  ...
  return (
    <div className="min-h-screen bg-transparent text-slate-700">
      <main>
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }}>
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-12">
                {[
                  ...
                  { title: "Baby Curry Fish (Stichopus naso)", text: "A valuable marine resource with significant potential in sustainable aquaculture and export markets due to its commercial importance and distinctive quality." },
          ...
          <div className="mx-auto max-w-7xl px-5 sm:px-8 lg:px-10 relative z-10">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }}>
              <div className="flex items-center gap-4 mb-6">
                ...
                <h2 className="font-serif text-3xl text-brown-dark sm:text-4xl">2. Sustainable Sea Cucumber Farming</h2>
              </div>
        ...
        {/* 3. Sea Cucumber Hatchery Project */}
        <section className="bg-transparent border-t border-glass-border py-20 sm:py-32 relative">
          ...
          <div className="mx-auto max-w-7xl px-5 sm:px-8 lg:px-10 relative z-10">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }}>
              <div className="flex items-center gap-4 mb-6">
                ...
                <h2 className="font-serif text-3xl text-brown-dark sm:text-4xl">3. Sea Cucumber Hatchery Project</h2>
              </div>
              ...
              <div className="text-center rounded-3xl border border-glass-border bg-white/60 p-12 backdrop-blur-md shadow-xl overflow-hidden relative">
